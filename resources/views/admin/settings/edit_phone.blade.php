@extends('layouts/admin/master') @section('title', "$title") @section('content') @php $phone = json_decode($edit->value); $i=1; @endphp
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Phone {{$i++}}</label>
                                    <div class="col-sm-9">
